...
<html lang="es">
	...
	<body>
		...
		<section class="subir_libro">
			...
			<form action="Herramientas/casax.php">
				<input type="submit">
			</form>

           <form action="Herramientas/casax.php" method="post" class="subir" id="subir">
	           ...
	           <div class="contenedor">
			        <div class="contenedor_izquierdo">
			            ...
			            <select name="genero" id="">
		                    ...
		                    <option value="">Ficción clásica</option>
		                    <option value="">ficción moderna</option>
		                    <option value="">Ficción para adultos</option>
		                    <option value="">Ficción para jóvenes </option>
		                    <option value="">Historia</option>
		                    <option value="">Humor</option>
		                    <option value="">Infantil</option>
		                    <option>Inspiracional</option>
		                    <option value="">Juvenil</option>
		                    <option value="">contemporánea</option>
		                    <option value="">Misterio</option>
		                    <option value="">Narrativa </option>
		                    <option value="">Novela histórica</option>
		                    <option value="">Novela negra</option>
		                    <option value="">Pensamiento</option>
		                    <option value="">Poesía y teatro</option>
		                    <option value="">Realismo mágico</option>
		                    <option value="">Romántica</option>
		                    <option>Suspenso</option>
		                    <option>Terror</option>
		                    <option value="">Viaje y aventura</option>
		                    <option>Otro...</option>
	                    </select>
